...
students = ["Del Boy", "Rodney", "Truffle"]
...
def hometown_info():
   borough = home_town['borough']
   city = home_town["city"]
   pop = home_town["population"]
   home_town_message = f"I was born in {borough}, {city} - population of {pop}. "
